...
# This will be evaluated only if you are in interactive mode
# so it won't be included in the rendered doc
if (interactive()) {
# Combining datasets and Mapping
  ...
  leaflet(dat) %>%
    ...
    addCircles(lng = ~lon, lat = ~lat, color=~type.pal(dat$type), opacity=1,fillOpacity=1, radius=500)
}
